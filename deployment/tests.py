...
def createDjango():
    return Framework.objects.create(name="django")


def createReact():
    return Framework.objects.create(name="react")


def createNode():
    return Framework.objects.create(name="nodejs")
...
class ProjectCreateTestCase(TestCase):
    ...
    def setUp(self):
        self.current_framework = "react"
        self.project_name = "test_project_" + self.current_framework
        self.repo_url = {
            "django":
            "https://github.com/dushyant19/Swc_teams_django_boilerplate.git",
